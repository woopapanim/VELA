  ...
  return (
    <section className="hero">
      <div className="topline">
        ...
        <span>{t('vela.hero.line', { version: meta.version, date: meta.generated.slice(0, 10) })}</span>
      </div>
      ...
      <div className="meta">
        ...
        <div className="cell"><div className="k">{t('vela.hero.kVersion')}</div><div className="v num">{meta.version}</div></div>
      </div>
    </section>
  );
}
