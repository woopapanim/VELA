...
export function createHyundaiScenario(): Scenario {
  ...
  const zones: ZoneConfig[] = [
    { id: 'h_entrance' as ZoneId, name: 'Grand Entrance', type: 'entrance', shape: 'rect', bounds: { x: 50, y: 350, w: 140, h: 200 }, polygon: null, area: 56, capacity: 50, flowType: 'free',
      gates: [
        { id: 'g_h_ent_in' as GateId, zoneId: 'h_entrance' as ZoneId, floorId: f1, type: 'entrance', position: { x: 50, y: 450 }, width: 60, connectedGateId: null, targetFloorId: null, targetGateId: null },
        { id: 'g_h_ent_out' as GateId, zoneId: 'h_entrance' as ZoneId, floorId: f1, type: 'exit', position: { x: 190, y: 450 }, width: 50, connectedGateId: 'g_h_welcome_in' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_welcome' as ZoneId, name: 'Welcome Plaza', type: 'exhibition', shape: 'rect', bounds: { x: 220, y: 250, w: 200, h: 300 }, polygon: null, area: 120, capacity: 60, flowType: 'free',
      gates: [
        { id: 'g_h_welcome_in' as GateId, zoneId: 'h_welcome' as ZoneId, floorId: f1, type: 'entrance', position: { x: 220, y: 400 }, width: 50, connectedGateId: 'g_h_ent_out' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_welcome_to_ioniq' as GateId, zoneId: 'h_welcome' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 420, y: 320 }, width: 50, connectedGateId: 'g_h_ioniq_in' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_welcome_to_heritage' as GateId, zoneId: 'h_welcome' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 420, y: 480 }, width: 50, connectedGateId: 'g_h_heritage_in' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_ioniq' as ZoneId, name: 'IONIQ Experience', type: 'exhibition', shape: 'rect', bounds: { x: 460, y: 150, w: 300, h: 220 }, polygon: null, area: 165, capacity: 80, flowType: 'guided',
      gates: [
        { id: 'g_h_ioniq_in' as GateId, zoneId: 'h_ioniq' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 460, y: 260 }, width: 50, connectedGateId: 'g_h_welcome_to_ioniq' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_ioniq_to_nx' as GateId, zoneId: 'h_ioniq' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 760, y: 260 }, width: 50, connectedGateId: 'g_h_nx_in' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_nx' as ZoneId, name: 'N / N Line Zone', type: 'exhibition', shape: 'rect', bounds: { x: 800, y: 150, w: 280, h: 220 }, polygon: null, area: 154, capacity: 70, flowType: 'free',
      gates: [
        { id: 'g_h_nx_in' as GateId, zoneId: 'h_nx' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 800, y: 260 }, width: 50, connectedGateId: 'g_h_ioniq_to_nx' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_nx_to_ev' as GateId, zoneId: 'h_nx' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 940, y: 370 }, width: 50, connectedGateId: 'g_h_ev_in' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_heritage' as ZoneId, name: 'Heritage Gallery', type: 'exhibition', shape: 'rect', bounds: { x: 460, y: 420, w: 300, h: 200 }, polygon: null, area: 150, capacity: 60, flowType: 'one_way',
      gates: [
        { id: 'g_h_heritage_in' as GateId, zoneId: 'h_heritage' as ZoneId, floorId: f1, type: 'entrance', position: { x: 460, y: 520 }, width: 50, connectedGateId: 'g_h_welcome_to_heritage' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_heritage_to_kids' as GateId, zoneId: 'h_heritage' as ZoneId, floorId: f1, type: 'exit', position: { x: 760, y: 520 }, width: 50, connectedGateId: 'g_h_kids_in' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_ev_experience' as ZoneId, name: 'EV Test Drive', type: 'exhibition', shape: 'rect', bounds: { x: 800, y: 400, w: 300, h: 200 }, polygon: null, area: 150, capacity: 30, flowType: 'guided',
      gates: [
        { id: 'g_h_ev_in' as GateId, zoneId: 'h_ev_experience' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 940, y: 400 }, width: 40, connectedGateId: 'g_h_nx_to_ev' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_ev_to_shop' as GateId, zoneId: 'h_ev_experience' as ZoneId, floorId: f1, type: 'exit', position: { x: 1100, y: 500 }, width: 40, connectedGateId: 'g_h_shop_in' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_kids' as ZoneId, name: 'Kids Zone', type: 'rest', shape: 'rect', bounds: { x: 460, y: 660, w: 200, h: 160 }, polygon: null, area: 80, capacity: 25, flowType: 'free',
      gates: [
        { id: 'g_h_kids_in' as GateId, zoneId: 'h_kids' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 560, y: 660 }, width: 40, connectedGateId: 'g_h_heritage_to_kids' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_kids_to_cafe' as GateId, zoneId: 'h_kids' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 660, y: 740 }, width: 40, connectedGateId: 'g_h_cafe_in' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_cafe' as ZoneId, name: 'Hyundai Cafe', type: 'rest', shape: 'rect', bounds: { x: 700, y: 660, w: 200, h: 160 }, polygon: null, area: 80, capacity: 35, flowType: 'free',
      gates: [
        { id: 'g_h_cafe_in' as GateId, zoneId: 'h_cafe' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 700, y: 740 }, width: 40, connectedGateId: 'g_h_kids_to_cafe' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_cafe_to_shop' as GateId, zoneId: 'h_cafe' as ZoneId, floorId: f1, type: 'bidirectional', position: { x: 900, y: 740 }, width: 40, connectedGateId: 'g_h_shop_from_cafe' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_shop' as ZoneId, name: 'Merchandise Shop', type: 'exhibition', shape: 'rect', bounds: { x: 1130, y: 400, w: 180, h: 250 }, polygon: null, area: 112, capacity: 40, flowType: 'free',
      gates: [
        { id: 'g_h_shop_in' as GateId, zoneId: 'h_shop' as ZoneId, floorId: f1, type: 'entrance', position: { x: 1130, y: 500 }, width: 40, connectedGateId: 'g_h_ev_to_shop' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_shop_from_cafe' as GateId, zoneId: 'h_shop' as ZoneId, floorId: f1, type: 'entrance', position: { x: 1130, y: 600 }, width: 40, connectedGateId: 'g_h_cafe_to_shop' as GateId, targetFloorId: null, targetGateId: null },
        { id: 'g_h_shop_to_exit' as GateId, zoneId: 'h_shop' as ZoneId, floorId: f1, type: 'exit', position: { x: 1310, y: 525 }, width: 50, connectedGateId: 'g_h_exit_in' as GateId, targetFloorId: null, targetGateId: null },
      ],
    ...
    { id: 'h_exit' as ZoneId, name: 'Exit Gate', type: 'exit', shape: 'rect', bounds: { x: 1250, y: 350, w: 120, h: 200 }, polygon: null, area: 60, capacity: 50, flowType: 'free',
      gates: [
        { id: 'g_h_exit_in' as GateId, zoneId: 'h_exit' as ZoneId, floorId: f1, type: 'entrance', position: { x: 1250, y: 450 }, width: 50, connectedGateId: 'g_h_shop_to_exit' as GateId, targetFloorId: null, targetGateId: null },
      ],
