...
import { FullReport } from '@/ui/reports/FullReport';
...
export function CompletionReport() {
    ...
    return (
      <div className="bento-box p-3">
        ...
        <p className="text-[10px] text-muted-foreground">
          Run simulation to generate report data.
        </p>
  ...
  return (
    <div className="bento-box p-3">
      ...
      <button
        onClick={() => setShowFullReport(true)}
        className="w-full flex items-center justify-center gap-1.5 px-3 py-2 mb-3 text-[11px] font-medium rounded-lg bg-primary/15 hover:bg-primary/25 text-primary ring-1 ring-primary/30 transition-colors"
      >
        <Maximize2 className="w-3 h-3" />
        View Full Report (PDF)
      </button>
