// Pure computation + types for the four-perspective analytics cards.
// The matching component (PerspectiveSlot + META icon table) lives in
// cards.tsx so React Fast Refresh can hot-reload component edits without
// invalidating this module.
...
// META (icon table per perspective) lives in cards.tsx alongside PerspectiveSlot.
