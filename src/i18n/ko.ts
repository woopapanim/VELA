...
export const ko: Dict = {
  ...
  'project.dirty.badge': '수정됨',
  'project.dirty.title': '저장하지 않은 변경사항이 있습니다',
  'project.dirty.runConfirm': '저장하지 않은 변경사항이 있습니다.\n\n이대로 시뮬레이션을 실행하면 결과를 다음 run 과 비교하기 어렵습니다.\n저장하시겠습니까?\n\n[확인] = 저장 안 하고 실행\n[취소] = 실행 중단 (먼저 Save)',
  ...
  // Analyze layout
  'analyze.title': '분석 결과',
  'analyze.subtitle': '시뮬레이션 결과 — 핵심 결론과 권고',
  'analyze.back': '시뮬레이션으로',
  'analyze.toBuild': 'Build 으로',
  'analyze.viewFromCompletion': '분석 보기',
  'analyze.verdict.success': '운영 양호',
  'analyze.verdict.warning': '주의 신호',
  'analyze.verdict.critical': '위험 신호',
  'analyze.verdict.empty': '데이터 부족',
  'analyze.verdict.empty.detail': '시뮬레이션을 더 길게 돌리거나 방문객 수를 늘려보세요',
  'analyze.kpi.completion': '완주율',
  'analyze.kpi.skip': '스킵률',
  'analyze.kpi.earlyLeave': '조기이탈',
  'analyze.kpi.peakLoad': '피크 점유',
  'analyze.kpi.fatigue': '평균 피로',
  'analyze.kpi.throughput': '처리량/분',
  ...
  'analyze.rail.hint': '위험 신호 · 흐름 · 관람 깊이',

  // Decision Cockpit
  'analyze.cockpit.headline.empty': '데이터 부족',
  'analyze.cockpit.headline.success': '운영 양호',
  'analyze.cockpit.headline.warning': '주의 — 일부 구역 과부하',
  'analyze.cockpit.headline.critical': '{zone} 과밀 ({ratio}%)',
  'analyze.cockpit.subline.empty': '시뮬레이션을 더 길게 돌리거나 방문객 수를 늘려보세요',
  'analyze.cockpit.subline.success': '큰 문제 없음 · 현 운영 유지',
  'analyze.cockpit.subline.warning': '병목/스킵이 임계치에 근접',
  'analyze.cockpit.subline.critical': '현재 전시 운영에 즉시 조치가 필요합니다',
  'analyze.cockpit.meta.location': '발생 위치',
  'analyze.cockpit.meta.scope': '영향 범위',
  'analyze.cockpit.meta.peak': '최대 점유',
  'analyze.cockpit.meta.skip': '스킵률',
  'analyze.cockpit.meta.completion': '완주율',
  'analyze.cockpit.meta.fatigue': '피로도',
  'analyze.cockpit.actions.title': '즉시 조치',
  'analyze.cockpit.actions.empty': '추천 액션 없음',
  'analyze.cockpit.action.dispersePeak': '{zone} 분산 유도',
  'analyze.cockpit.action.dispersePeak.detail': '피크 점유 {ratio}% — Entry 분산/체류 시간 단축 검토',
  'analyze.cockpit.action.skipMedia': '{media} 노출 조정',
  'analyze.cockpit.action.skipMedia.detail': '스킵률 {rate}% — 위치/콘텐츠/지속시간 검토',
  'analyze.cockpit.action.balanceExits': '입출구 균형 조정',
  'analyze.cockpit.action.balanceExits.detail': '잔류 {count}명 — Exit 가시성 또는 동선 검토',
  'analyze.cockpit.action.cta': 'Build 에서 검토',
  'analyze.cockpit.section.where': '어디서 막혔는지',
  'analyze.cockpit.section.when': '언제 발생했는지',
  'analyze.cockpit.section.what': '어떤 콘텐츠가 문제인지',
  'analyze.cockpit.runContext.label': '시뮬레이션 조건',
  'analyze.cockpit.runContext.total': '총 {count}명',
  'analyze.cockpit.runContext.seed': '시드 {seed}',
  'analyze.cockpit.action.saveReminder': '조정 후 Save 한 다음 시뮬레이션을 돌리면 같은 묶음으로 비교됩니다.',
  'analyze.runs.live': '라이브 (현재 진행)',
  'analyze.runs.live.hint': '저장 안 됨',
  'analyze.runs.tooltip': '시뮬레이션 run 히스토리 — 같은 시나리오끼리 묶여 있습니다',
  'analyze.runs.dirtyTag': '변경됨',
  'analyze.runs.remove': '이 run 삭제',
  'analyze.runs.removeConfirm': '이 run 기록을 삭제하시겠습니까? 비교 묶음에서 제외됩니다.',
  'profile.general': '일반',
  'profile.vip': 'VIP',
  'profile.child': '어린이',
  'profile.elderly': '노약자',
  'profile.disabled': '교통약자',
  ...
  // Build — task labels (TaskPanel + ToolDock 공유)
  'build.task.region': '영역',
  'build.task.zones': '존',
  'build.task.exhibits': '전시품',
  'build.task.flow': '동선',
  'build.task.visitors': '방문객',
  'build.taskHint.region': '도면 이미지를 배치하고 디자인할 영역을 정합니다.',
  'build.taskHint.zones': '존을 그립니다 — 로비, 전시실, 휴게, 출구.',
  'build.taskHint.exhibits': '존 안에 작품과 미디어를 배치합니다.',
  'build.taskHint.flow': '웨이포인트를 연결해 방문객 동선을 정의합니다.',
  'build.taskHint.visitors': '방문객 프로필 · 참여도 · 그룹 구성.',
  'build.toolDock.collapse': '접기',
  'build.toolDock.expand': '펼치기',

  // Build — TopBar
  'build.topBar.stage.build': '빌드',
  'build.topBar.stage.simulate': '시뮬',
  'build.topBar.stage.analyze': '분석',
  'build.topBar.run': '시뮬레이션 실행',
  'build.topBar.runReason.noScenario': '시나리오를 먼저 불러오거나 만드세요',
  'build.topBar.runReason.noZone': '존을 최소 하나 추가하세요',
  'build.topBar.runReason.noMedia': '전시품을 최소 하나 추가하세요',
  'build.topBar.runReason.ready': '시뮬레이션 실행',

  // Build — Inspector (slide-in)
  'build.inspector.kind.zone': '존',
  'build.inspector.kind.exhibit': '전시품',
  'build.inspector.kind.waypoint': '웨이포인트',
  'build.inspector.close': '닫기',

  // Project manager — visible buttons
  'project.action.new': '새로',
  'project.action.save': '저장',
  'project.action.exportJson': 'JSON 내보내기',
  'project.namePlaceholder': '프로젝트 이름',
  'project.namePlaceholder.default': '새 프로젝트',
  'project.recent': '최근',

  // Zone templates — section + names
  'zoneTemplate.section.title': '존 템플릿',
  'zoneTemplate.linear.label': '일렬',
  'zoneTemplate.hub.label': '허브 & 스포크',
  'zoneTemplate.grid.label': '격자',
  'zoneTemplate.hall.label': '대형 홀',

  // Regions panel
  'regions.title': '영역 ({count})',
  'regions.action.arrange': '정렬',
  'regions.action.arrange.title': '동일 레벨끼리 옆으로 자동 정렬',
  'regions.action.add': '추가',
  'regions.action.add.title': '영역 추가',
  'regions.zoneCount': '{count}개 존',
  'regions.action.save': '저장',
  'regions.overlay.upload': '이미지 업로드',
  'regions.overlay.edit': '편집',
  'regions.overlay.replace': '교체',
  'regions.overlay.show': '오버레이 표시',
  'regions.overlay.hide': '오버레이 숨김',
  'regions.overlay.remove': '오버레이 제거',
  'regions.overlay.scale': '배율',

  // Zone editor
  'zoneEditor.title': '존 편집',
  'zoneEditor.field.name': '이름',
  'zoneEditor.field.capacity': '수용 인원',
  'zoneEditor.field.area': '면적 (m²)',
  'zoneEditor.field.autoCalc': '자동 계산 (순면적)',
  'zoneEditor.field.type': '유형',
  'zoneEditor.field.flow': '동선',
  'zoneEditor.field.shape': '형태',
  'zoneEditor.field.attractiveness': '매력도',
  'zoneEditor.field.attractiveness.low': '낮음',
  'zoneEditor.field.attractiveness.high': '높음',
  'zoneEditor.field.mustVisit': '필수 방문',
  'zoneEditor.mustVisit.tooltip': '히어로 존 — 모든 관람객이 반드시 방문. 피로·skip 로직 무시.',
  'zoneEditor.mustVisit.on': '★ 히어로',
  'zoneEditor.mustVisit.off': '꺼짐',
  'zoneEditor.gateway.label': '게이트웨이 방향',
  'zoneEditor.gateway.spawn': '↓ 스폰',
  'zoneEditor.gateway.exit': '↑ 퇴장',
  'zoneEditor.gateway.both': '↕ 양방향',
  'zoneEditor.delete.title': '존 삭제',
  'zoneEditor.summary': '{w}×{h}m · {shape} · 전시품 {count}',
  'zoneEditor.type.entrance': '입구',
  'zoneEditor.type.exhibition': '전시',
  'zoneEditor.type.rest': '휴게',
  'zoneEditor.type.stage': '스테이지',
  'zoneEditor.type.exit': '출구',
  'zoneEditor.flow.free': '자유',
  'zoneEditor.flow.guided': '안내',
  'zoneEditor.flow.oneWay': '일방향',
  'zoneEditor.shape.rect': '직사각형',
  'zoneEditor.shape.circle': '원형',
  'zoneEditor.shape.lTopLeft': 'L (좌상)',
  'zoneEditor.shape.lTopRight': 'L (우상)',
  'zoneEditor.shape.lBottomLeft': 'L (좌하)',
  'zoneEditor.shape.lBottomRight': 'L (우하)',
  'zoneEditor.shape.oRing': 'O형',
  'zoneEditor.shape.custom': '폴리곤 (커스텀)',

  // Media editor
  'mediaEditor.title': '전시품 편집',
  'mediaEditor.field.name': '이름',
  'mediaEditor.field.width': '너비 (m)',
  'mediaEditor.field.height': '높이 (m)',
  'mediaEditor.field.orientation': '방향',
  'mediaEditor.field.shape': '형태',
  'mediaEditor.field.interaction': '상호작용',
  'mediaEditor.field.omnidirectional': '전방향',
  'mediaEditor.field.sessionInterval': '세션 간격 (초)',
  'mediaEditor.field.capacity': '수용 인원',
  'mediaEditor.field.autoCap': '자동 산정',
  'mediaEditor.field.autoCap.apply': '적용',
  'mediaEditor.field.engagement': '관람 시간 (초)',
  'mediaEditor.field.viewDistance': '관람 거리 (m)',
  'mediaEditor.field.attractiveness': '매력도',
  'mediaEditor.field.mustVisit': '필수 방문',
  'mediaEditor.field.queueBehavior': '대기 행동',
  'mediaEditor.field.groupFriendly': '단체 가능',
  'mediaEditor.mustVisit.tooltip': '히어로 전시 — 모든 관람객이 반드시 관람. skip·대기 포기 로직 무시. 체류는 프로필×피로에 따라 단축.',
  'mediaEditor.mustVisit.on': '★ 히어로',
  'mediaEditor.mustVisit.off': '꺼짐',
  'mediaEditor.shape.rect': '직사각형',
  'mediaEditor.shape.circle': '원형',
  'mediaEditor.shape.ellipse': '타원',
  'mediaEditor.shape.custom': '폴리곤',
  'mediaEditor.interaction.passive': '수동',
  'mediaEditor.interaction.active': '능동',
  'mediaEditor.interaction.staged': '회차제',
  'mediaEditor.interaction.analog': '아날로그',
  'mediaEditor.omni.on': '360°',
  'mediaEditor.omni.off': '전면',
  'mediaEditor.queue.none': '없음',
  'mediaEditor.queue.linear': '선형',
  'mediaEditor.queue.area': '구역',
  'mediaEditor.group.yes': '가능',
  'mediaEditor.group.no': '불가',
  'mediaEditor.category.analog': '아날로그',
  'mediaEditor.category.passive': '수동',
  'mediaEditor.category.active': '능동',
  'mediaEditor.category.immersive': '몰입',

  // Waypoint inspector
  'waypoint.node.title': '노드 인스펙터',
  'waypoint.node.delete': '노드 삭제',
  'waypoint.node.field.type': '유형',
  'waypoint.node.field.label': '이름',
  'waypoint.node.field.attraction': '매력도: {value}',
  'waypoint.node.field.dwell': '체류: {value}초',
  'waypoint.node.field.poiCapacity': 'POI 수용: {value}',
  'waypoint.node.field.spawnWeight': '스폰 가중치: {value}',
  'waypoint.node.type.entry': '입구',
  'waypoint.node.type.exit': '출구',
  'waypoint.node.type.zone': '존',
  'waypoint.node.type.attractor': '어트랙터',
  'waypoint.node.type.hub': '허브',
  'waypoint.node.type.rest': '휴게',
  'waypoint.node.type.bend': '굴절',
  'waypoint.node.type.portal': '포털',
  'waypoint.shaft.label': '샤프트',
  'waypoint.shaft.tooltip': '포털 샤프트 그룹. 같은 샤프트의 노드들은 층/건물 간 서로 연결. 에이전트는 대기 + 이동 후 텔레포트.',
  'waypoint.shaft.none': '— 없음 —',
  'waypoint.shaft.new': '+ 새 샤프트',
  'waypoint.shaft.name': '샤프트 이름',
  'waypoint.shaft.capacity': '수용: {value}',
  'waypoint.shaft.capacity.tooltip': '운행 1회당 캐빈 최대 인원.',
  'waypoint.shaft.wait': '대기: {value}초',
  'waypoint.shaft.wait.tooltip': '캐빈 도착 대기 + 탑승 시간.',
  'waypoint.shaft.travel': '층당 이동: {value}초',
  'waypoint.shaft.travel.tooltip': '층당 이동 시간. 총 = 대기 + |층 수| × 이 값.',
  'waypoint.edge.title': '엣지 인스펙터',
  'waypoint.edge.delete': '엣지 삭제',
  'waypoint.edge.direction': '방향',
  'waypoint.edge.directed': '단방향 →',
  'waypoint.edge.bidirectional': '양방향 ↔',
  'waypoint.edge.passWeight': '통과 가중치: {value}',
  'waypoint.edge.cost': '비용: {value}px',

  // Simulation controls
  'simControls.start': '시작',
  'simControls.pause': '일시정지',
  'simControls.resume': '재개',
  'simControls.stop': '중지',
  'simControls.heatmap.toggle': '히트맵 전환',
  'simControls.speed': '속도',
  'simControls.phase': '상태',
  'simControls.elapsed': '경과',
  'simControls.activeAgents': '활성 에이전트',
  'simControls.tick': '틱',
  'simControls.toast.completed': '✅ 시뮬레이션 완료!',
  'simControls.toast.milestone': '🏆 {count}명 도달!',
  'simControls.toast.bottleneck': '⚠️ {zone} 병목 ({score})',
  'simControls.modeBadge.person': '👥 사람 기준 · {count}명 · 최대 {min}분',
  'simControls.modeBadge.time': '🕐 시간 기준 · {min}분 · 최대 {count}명',

  // Visitor config sections
  'visitorConfig.profile': '프로필 구성',
  'visitorConfig.engagement': '관람 성향 구성',
  'visitorConfig.category': '카테고리 구성',

  // Spawn config sections
  'spawnConfig.presets': '프리셋',
  'spawnConfig.settings': '스폰 설정',
  'spawnConfig.timeSlots': '시간대',
  'spawnConfig.totalVisitors': '총 관람객',
  'spawnConfig.maxConcurrent': '최대 동시',
  'spawnConfig.spawnRate': '스폰 속도 /분',
  'spawnConfig.spawnRate.multiSlot': '스폰 속도 /분 (다중 시간대)',
  'spawnConfig.spawnRate.editInSlots': '시간대에서 편집',
  'spawnConfig.duration': '시간 (분)',
  'spawnConfig.seed': '시드',
  'spawnConfig.seed.randomize': '🎲 랜덤',
};
