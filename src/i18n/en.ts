...
export const en: Dict = {
  ...
  'vela.sys.col.visitDist': 'Zone Visit Distribution',
  'vela.sys.col.composition': 'Composition',
  'vela.sys.donut.visits': 'VISITS',
  'vela.sys.donut.noData': 'NO DATA',
  'vela.sys.donut.note': '{count} zones visited · {total} cumulative visits',
  ...
  'vela.sys.kv.avgCrowd': 'Avg. crowding (live)',
  'vela.sys.kv.avgTransit': 'Avg. transit time',
