...
export const en: Dict = {
  ...
  'project.dirty.badge': 'Modified',
  'project.dirty.title': 'Unsaved changes',
  'project.dirty.runConfirm': 'You have unsaved changes.\n\nRunning now will make it harder to compare results across runs.\nSave first?\n\n[OK] = Run without saving\n[Cancel] = Stop and Save first',
  ...
  'analyze.subtitle': 'Simulation outcome — verdict and recommendations',
  'analyze.back': 'Back to Simulate',
  'analyze.toBuild': 'Back to Build',
  'analyze.viewFromCompletion': 'View Analysis',
  'analyze.verdict.success': 'Operating well',
  'analyze.verdict.warning': 'Watch signals',
  'analyze.verdict.critical': 'Critical signals',
  'analyze.verdict.empty': 'Not enough data',
  'analyze.verdict.empty.detail': 'Run longer or increase visitor count',
  'analyze.kpi.completion': 'Completion',
  'analyze.kpi.skip': 'Skip rate',
  'analyze.kpi.earlyLeave': 'Early leave',
  'analyze.kpi.peakLoad': 'Peak load',
  'analyze.kpi.fatigue': 'Avg fatigue',
  'analyze.kpi.throughput': 'Thru/min',
  ...
  'analyze.rail.title': 'Key insights',
  'analyze.rail.hint': 'Risk signals · flow · engagement',

  // Decision Cockpit
  'analyze.cockpit.headline.empty': 'Not enough data',
  'analyze.cockpit.headline.success': 'Operating well',
  'analyze.cockpit.headline.warning': 'Some zones near capacity',
  'analyze.cockpit.headline.critical': '{zone} overcrowded ({ratio}%)',
  'analyze.cockpit.subline.empty': 'Run longer or add more visitors',
  'analyze.cockpit.subline.success': 'No major issues — keep current operation',
  'analyze.cockpit.subline.warning': 'Bottlenecks/skips approaching threshold',
  'analyze.cockpit.subline.critical': 'Immediate action required',
  'analyze.cockpit.meta.location': 'Location',
  'analyze.cockpit.meta.scope': 'Scope',
  'analyze.cockpit.meta.peak': 'Peak',
  'analyze.cockpit.meta.skip': 'Skip',
  'analyze.cockpit.meta.completion': 'Completion',
  'analyze.cockpit.meta.fatigue': 'Fatigue',
  'analyze.cockpit.actions.title': 'Immediate actions',
  'analyze.cockpit.actions.empty': 'No recommended actions',
  'analyze.cockpit.action.dispersePeak': 'Disperse {zone}',
  'analyze.cockpit.action.dispersePeak.detail': 'Peak {ratio}% — review entry distribution / dwell',
  'analyze.cockpit.action.skipMedia': 'Adjust {media}',
  'analyze.cockpit.action.skipMedia.detail': 'Skip rate {rate}% — review placement / content / duration',
  'analyze.cockpit.action.balanceExits': 'Balance entry / exit',
  'analyze.cockpit.action.balanceExits.detail': '{count} stranded — review exit visibility',
  'analyze.cockpit.action.cta': 'Review in Build',
  'analyze.cockpit.section.where': 'Where it bottlenecks',
  'analyze.cockpit.section.when': 'When it spiked',
  'analyze.cockpit.section.what': 'What content struggles',
  'analyze.cockpit.runContext.label': 'Run conditions',
  'analyze.cockpit.runContext.total': '{count} visitors',
  'analyze.cockpit.runContext.seed': 'seed {seed}',
  'analyze.cockpit.action.saveReminder': 'Save before re-running so the new run lands in the same comparison group.',
  'analyze.runs.live': 'Live (current)',
  'analyze.runs.live.hint': 'unsaved',
  'analyze.runs.tooltip': 'Run history — grouped by scenario',
  'analyze.runs.dirtyTag': 'modified',
  'analyze.runs.remove': 'Remove this run',
  'analyze.runs.removeConfirm': 'Remove this run record? It will be excluded from comparison groups.',
  'profile.general': 'General',
  'profile.vip': 'VIP',
  'profile.child': 'Child',
  'profile.elderly': 'Elderly',
  'profile.disabled': 'Accessible',
  ...
  // Build — task labels (TaskPanel + ToolDock)
  'build.task.region': 'Region',
  'build.task.zones': 'Zones',
  'build.task.exhibits': 'Exhibits',
  'build.task.flow': 'Flow',
  'build.task.visitors': 'Visitors',
  'build.taskHint.region': 'Place the floor image and the region you will design within.',
  'build.taskHint.zones': 'Draw zones — lobby, exhibition halls, rest, exit.',
  'build.taskHint.exhibits': 'Place artworks and digital media inside zones.',
  'build.taskHint.flow': 'Connect waypoints to define how visitors move.',
  'build.taskHint.visitors': 'Visitor profile · engagement · group mix.',
  'build.toolDock.collapse': 'Collapse',
  'build.toolDock.expand': 'Expand',

  // Build — TopBar
  'build.topBar.stage.build': 'Build',
  'build.topBar.stage.simulate': 'Simulate',
  'build.topBar.stage.analyze': 'Analyze',
  'build.topBar.run': 'Run Simulation',
  'build.topBar.runReason.noScenario': 'Load or create a scenario first',
  'build.topBar.runReason.noZone': 'Add at least one zone',
  'build.topBar.runReason.noMedia': 'Add at least one exhibit',
  'build.topBar.runReason.ready': 'Run simulation',

  // Build — Inspector (slide-in)
  'build.inspector.kind.zone': 'Zone',
  'build.inspector.kind.exhibit': 'Exhibit',
  'build.inspector.kind.waypoint': 'Waypoint',
  'build.inspector.close': 'Close',

  // Project manager — visible buttons
  'project.action.new': 'New',
  'project.action.save': 'Save',
  'project.action.exportJson': 'Export JSON',
  'project.namePlaceholder': 'Project name',
  'project.namePlaceholder.default': 'New Project',
  'project.recent': 'Recent',

  // Zone templates — section + names
  'zoneTemplate.section.title': 'Zone Templates',
  'zoneTemplate.linear.label': 'Linear',
  'zoneTemplate.hub.label': 'Hub & Spoke',
  'zoneTemplate.grid.label': 'Grid',
  'zoneTemplate.hall.label': 'Large Hall',

  // Regions panel
  'regions.title': 'Regions ({count})',
  'regions.action.arrange': 'Arrange',
  'regions.action.arrange.title': 'Auto-arrange regions side-by-side by level',
  'regions.action.add': 'Add',
  'regions.action.add.title': 'Add floor',
  'regions.zoneCount': '{count} zones',
  'regions.action.save': 'Save',
  'regions.overlay.upload': 'Upload Image',
  'regions.overlay.edit': 'Edit',
  'regions.overlay.replace': 'Replace',
  'regions.overlay.show': 'Show overlay',
  'regions.overlay.hide': 'Hide overlay',
  'regions.overlay.remove': 'Remove overlay',
  'regions.overlay.scale': 'Scale',

  // Zone editor
  'zoneEditor.title': 'Edit Zone',
  'zoneEditor.field.name': 'Name',
  'zoneEditor.field.capacity': 'Capacity',
  'zoneEditor.field.area': 'Area (m²)',
  'zoneEditor.field.autoCalc': 'Auto-calc (net)',
  'zoneEditor.field.type': 'Type',
  'zoneEditor.field.flow': 'Flow',
  'zoneEditor.field.shape': 'Shape',
  'zoneEditor.field.attractiveness': 'Attractiveness',
  'zoneEditor.field.attractiveness.low': 'Low',
  'zoneEditor.field.attractiveness.high': 'High',
  'zoneEditor.field.mustVisit': 'Must Visit',
  'zoneEditor.mustVisit.tooltip': 'Hero zone — every visitor must visit. Bypasses fatigue and skip logic.',
  'zoneEditor.mustVisit.on': '★ Hero',
  'zoneEditor.mustVisit.off': 'Off',
  'zoneEditor.gateway.label': 'Gateway Direction',
  'zoneEditor.gateway.spawn': '↓ Spawn',
  'zoneEditor.gateway.exit': '↑ Exit',
  'zoneEditor.gateway.both': '↕ Both',
  'zoneEditor.delete.title': 'Delete zone',
  'zoneEditor.summary': '{w}×{h}m · {shape} · {count} media',
  'zoneEditor.type.entrance': 'Entrance',
  'zoneEditor.type.exhibition': 'Exhibition',
  'zoneEditor.type.rest': 'Rest',
  'zoneEditor.type.stage': 'Stage',
  'zoneEditor.type.exit': 'Exit',
  'zoneEditor.flow.free': 'Free',
  'zoneEditor.flow.guided': 'Guided',
  'zoneEditor.flow.oneWay': 'One-Way',
  'zoneEditor.shape.rect': 'Rectangle',
  'zoneEditor.shape.circle': 'Circle',
  'zoneEditor.shape.lTopLeft': 'L (Top-Left)',
  'zoneEditor.shape.lTopRight': 'L (Top-Right)',
  'zoneEditor.shape.lBottomLeft': 'L (Bottom-Left)',
  'zoneEditor.shape.lBottomRight': 'L (Bottom-Right)',
  'zoneEditor.shape.oRing': 'O-Ring',
  'zoneEditor.shape.custom': 'Polygon (Custom)',

  // Media editor
  'mediaEditor.title': 'Edit Media',
  'mediaEditor.field.name': 'Name',
  'mediaEditor.field.width': 'Width (m)',
  'mediaEditor.field.height': 'Height (m)',
  'mediaEditor.field.orientation': 'Orientation',
  'mediaEditor.field.shape': 'Shape',
  'mediaEditor.field.interaction': 'Interaction',
  'mediaEditor.field.omnidirectional': 'Omnidirectional',
  'mediaEditor.field.sessionInterval': 'Session Interval (s)',
  'mediaEditor.field.capacity': 'Capacity',
  'mediaEditor.field.autoCap': 'Auto Cap',
  'mediaEditor.field.autoCap.apply': 'Apply',
  'mediaEditor.field.engagement': 'Engagement (s)',
  'mediaEditor.field.viewDistance': 'View Distance (m)',
  'mediaEditor.field.attractiveness': 'Attractiveness',
  'mediaEditor.field.mustVisit': 'Must Visit',
  'mediaEditor.field.queueBehavior': 'Queue Behavior',
  'mediaEditor.field.groupFriendly': 'Group Friendly',
  'mediaEditor.mustVisit.tooltip': 'Hero exhibit — every visitor must view. Bypasses skip and queue-abandon logic. Stay time still scales by profile and fatigue.',
  'mediaEditor.mustVisit.on': '★ Hero',
  'mediaEditor.mustVisit.off': 'Off',
  'mediaEditor.shape.rect': 'Rectangle',
  'mediaEditor.shape.circle': 'Circle',
  'mediaEditor.shape.ellipse': 'Ellipse',
  'mediaEditor.shape.custom': 'Polygon',
  'mediaEditor.interaction.passive': 'Passive',
  'mediaEditor.interaction.active': 'Active',
  'mediaEditor.interaction.staged': 'Staged',
  'mediaEditor.interaction.analog': 'Analog',
  'mediaEditor.omni.on': '360°',
  'mediaEditor.omni.off': 'Front',
  'mediaEditor.queue.none': 'None',
  'mediaEditor.queue.linear': 'Linear',
  'mediaEditor.queue.area': 'Area',
  'mediaEditor.group.yes': 'Yes',
  'mediaEditor.group.no': 'No',
  'mediaEditor.category.analog': 'Analog',
  'mediaEditor.category.passive': 'Passive',
  'mediaEditor.category.active': 'Active',
  'mediaEditor.category.immersive': 'Immersive',

  // Waypoint inspector
  'waypoint.node.title': 'Node Inspector',
  'waypoint.node.delete': 'Delete node',
  'waypoint.node.field.type': 'Type',
  'waypoint.node.field.label': 'Label',
  'waypoint.node.field.attraction': 'Attraction: {value}',
  'waypoint.node.field.dwell': 'Dwell: {value}s',
  'waypoint.node.field.poiCapacity': 'POI Capacity: {value}',
  'waypoint.node.field.spawnWeight': 'Spawn Weight: {value}',
  'waypoint.node.type.entry': 'Entry',
  'waypoint.node.type.exit': 'Exit',
  'waypoint.node.type.zone': 'Zone',
  'waypoint.node.type.attractor': 'Attractor',
  'waypoint.node.type.hub': 'Hub',
  'waypoint.node.type.rest': 'Rest',
  'waypoint.node.type.bend': 'Bend',
  'waypoint.node.type.portal': 'Portal',
  'waypoint.shaft.label': 'Shaft',
  'waypoint.shaft.tooltip': 'Portal shaft group. All nodes sharing a shaft connect to each other across floors/buildings. Agents wait + travel before teleporting.',
  'waypoint.shaft.none': '— None —',
  'waypoint.shaft.new': '+ New shaft',
  'waypoint.shaft.name': 'Shaft name',
  'waypoint.shaft.capacity': 'Capacity: {value}',
  'waypoint.shaft.capacity.tooltip': 'Max agents inside the cabin per trip.',
  'waypoint.shaft.wait': 'Wait: {value}s',
  'waypoint.shaft.wait.tooltip': 'Time spent waiting for the cabin to arrive + board.',
  'waypoint.shaft.travel': 'Travel / floor: {value}s',
  'waypoint.shaft.travel.tooltip': 'Per-floor travel time. Total = wait + |floors| × this.',
  'waypoint.edge.title': 'Edge Inspector',
  'waypoint.edge.delete': 'Delete edge',
  'waypoint.edge.direction': 'Direction',
  'waypoint.edge.directed': 'Directed →',
  'waypoint.edge.bidirectional': 'Bidirectional ↔',
  'waypoint.edge.passWeight': 'Pass Weight: {value}',
  'waypoint.edge.cost': 'Cost: {value}px',

  // Simulation controls
  'simControls.start': 'Start',
  'simControls.pause': 'Pause',
  'simControls.resume': 'Resume',
  'simControls.stop': 'Stop',
  'simControls.heatmap.toggle': 'Toggle Heatmap',
  'simControls.speed': 'Speed',
  'simControls.phase': 'Phase',
  'simControls.elapsed': 'Elapsed',
  'simControls.activeAgents': 'Active Agents',
  'simControls.tick': 'Tick',
  'simControls.toast.completed': '✅ Simulation completed!',
  'simControls.toast.milestone': '🏆 {count} agents reached!',
  'simControls.toast.bottleneck': '⚠️ {zone} bottleneck ({score})',
  'simControls.modeBadge.person': '👥 Person · {count} ppl · max {min}min',
  'simControls.modeBadge.time': '🕐 Time · {min}min · max {count} ppl',

  // Visitor config sections
  'visitorConfig.profile': 'Profile Mix',
  'visitorConfig.engagement': 'Engagement Mix',
  'visitorConfig.category': 'Category Mix',

  // Spawn config sections
  'spawnConfig.presets': 'Presets',
  'spawnConfig.settings': 'Spawn Settings',
  'spawnConfig.timeSlots': 'Time Slots',
  'spawnConfig.totalVisitors': 'Total Visitors',
  'spawnConfig.maxConcurrent': 'Max Concurrent',
  'spawnConfig.spawnRate': 'Spawn Rate /min',
  'spawnConfig.spawnRate.multiSlot': 'Spawn Rate /min (multi-slot)',
  'spawnConfig.spawnRate.editInSlots': 'Edit in Time Slots',
  'spawnConfig.duration': 'Duration (min)',
  'spawnConfig.seed': 'Seed',
  'spawnConfig.seed.randomize': '🎲 Randomize',
};
